...
int main()
{
	...
	cout<<"--------------------------------------------------"<<endl;
	cout<<"||            first impact                       ||"<<endl;
	cout<<"--------------------------------------------------"<<endl;
   	cout<<"|Subject Teacher ->> Sir Abrar <<-- |\n"<<endl;
   	cout<<">>>----Project Made By-----<<<"<<endl;
   	cout<<">>>----AMMAR HANIF b-26257-----<<<"<<endl;
   	cout<<">>>----ASHAD ALI   b-26189-----<<<"<<endl;
	system("pause");
	system("cls");
	system("color 8f");
    system("cls");
        ...
        if(strcmp(password, "ammar123")==0){
            ...
            do{
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"I'm a virtual assistant created by AMMAR !!!"<<endl;
                    string phrase = "I am a virtual assistant created by AMMAR";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
